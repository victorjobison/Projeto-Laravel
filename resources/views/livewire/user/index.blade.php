                    ...
                    <div class="sm:flex-auto ">
                        <div class="flex">
                            <div class="relative text-gray-600">
                                <input type="search" name="serch" placeholder="Search" wire:model.live="search"class=" form control bg-white h-10 px-5 pr-10 rounded-full text-sm focus:outline-none">
